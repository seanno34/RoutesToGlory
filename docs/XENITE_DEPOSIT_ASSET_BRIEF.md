...
**Gameplay design:** [XENITE_DEPOSIT_DESIGN_BRIEF.md](../apps/unity-poc/docs/XENITE_DEPOSIT_DESIGN_BRIEF.md)  
**Asset brief (canonical):** [XENITE_DEPOSIT_ASSET_BRIEF.md](../apps/unity-poc/docs/XENITE_DEPOSIT_ASSET_BRIEF.md)  
**Architecture:** [CESIUM_ALIEN_WORLD_ARCHITECTURE.md](../apps/unity-poc/docs/CESIUM_ALIEN_WORLD_ARCHITECTURE.md)  
**Glider precedent:** [GLIDER_HERO_ASSET_BRIEF.md](GLIDER_HERO_ASSET_BRIEF.md)
...
- [ ] Create prefab `xenite_rift.prefab` at Resources path above
...
1. Generate / download from Tripo
2. Place under `Assets/TripoModels/xenite_vent/` (git-track or LFS per team policy)
3. Clean pivot & scale in Blender if needed
4. Build prefab → move to `Assets/Resources/RTG_Deposits/xenite_rift.prefab`
5. Play mode — no code changes if Resources path matches
